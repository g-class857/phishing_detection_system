...
# =======================================
N_TRIALS = 50                      
TUNE_SUBSET_MAX = 60000             
TUNE_NUM_BOOST_ROUND = 600          
TUNE_EARLY_STOP = 30                
OPTUNA_TIMEOUT_SECONDS = 60 * 60 * 4  
...
def objective(trial): # called by optuna for each huperparameter combination
    ...
    # create DMatrix
    # =====================
    dtrain = xgb.DMatrix(X_sub, label=y_sub, nthread=2) #  highly optimized data format, it converts standard pandas/numpy data into a specialized memory structure that XGBoost can process fast.
    # =========================
    # Cross Validation
    # =========
    cv = xgb.cv( 
...
# ========================
# sklearn wrapper (for deployment)
# ===========================
